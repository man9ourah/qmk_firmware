...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [__BASE] = LAYOUT(
        KC_CAPS, KC_WHOM, KC_MAIL, KC_F13,  KC_F14,  KC_F15,  KC_CALC, KC_PSCR, KC_F16,  KC_F17,   KC_MPRV, KC_MPLY, KC_MNXT,  KC_DEL,           KC_MUTE,
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, MO(__FUN), KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [__FUN] = LAYOUT(
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,    KC_F12, TG(__SEC),       _______,
    ...
    [__SEC] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_F18,
